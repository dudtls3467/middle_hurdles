...
@WebServlet("/owner/ownRestaurantDelete.do")
public class OwnRestaurantDeleteController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect(req.getContextPath() + "/owner/ownRestrauntDetail.do?restaurantNo=" + param.getRestaurantNo());
