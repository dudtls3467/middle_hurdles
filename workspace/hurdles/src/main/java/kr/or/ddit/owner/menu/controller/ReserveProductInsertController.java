...
@WebServlet("/owner/reserveProductInsert.do")
@MultipartConfig
public class ReserveProductInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ctx.getRequestDispatcher("/WEB-INF/view/owner/menu/reserveProductInsert.jsp").forward(req, resp);
	}


	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String[] requiredParams = { "restaurantNo", "reserveProductName", "reserveProductCount" };
		...
		int reserveProductVoNo = menuService.getReserveProductNo();
		insertMenu.setReserveProductNo(reserveProductVoNo);
		...
		// 메뉴 추가
		int result = menuService.reserveProductInsert(insertMenu);

		resp.sendRedirect(req.getContextPath() + "/owner/reserveProductDetail.do?reserveProductNo=" + insertMenu.getReserveProductNo()
