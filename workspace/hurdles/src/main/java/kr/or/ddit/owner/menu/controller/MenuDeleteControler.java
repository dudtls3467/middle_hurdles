...
@WebServlet("/owner/menuDelete.do")
public class MenuDeleteControler extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 메뉴 삭제
		menuService.menuDelete(param);
		
		resp.sendRedirect(req.getContextPath() + "/owner/menuList.do?restaurantNo=" + param.getRestaurantNo()
