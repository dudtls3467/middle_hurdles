...
@WebServlet("/owner/menuUpdate.do")
@MultipartConfig
public class MenuUpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		MenuVo item = menuService.menuDetail(param);
		...
		ctx.getRequestDispatcher("/WEB-INF/view/owner/menu/menuUpdate.jsp").forward(req, resp);
	}

	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String[] requiredParams = { "menuNo", "menuName", "menuPrice" };
		...
		// 메뉴 추가
		int result = menuService.menuUpdate(insertMenu);

		resp.sendRedirect(
				req.getContextPath()
				+ "/owner/menuDetail.do?menuNo=" + insertMenu.getMenuNo()
