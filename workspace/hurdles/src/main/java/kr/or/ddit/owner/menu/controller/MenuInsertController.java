...
@WebServlet("/owner/menuInsert.do")
@MultipartConfig
public class MenuInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ctx.getRequestDispatcher("/WEB-INF/view/owner/menu/menuInsert.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int menuNo = menuService.getMenuNo();
		insertMenu.setMenuNo(menuNo);
		...
		// 메뉴 추가
		int result = menuService.menuInsert(insertMenu);

		resp.sendRedirect(req.getContextPath() + "/owner/menuDetail.do?menuNo=" + insertMenu.getMenuNo()
