...
@WebServlet("/admin/boardUpdate.do")
@MultipartConfig
public class BoardUpdateContoller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ctx.getRequestDispatcher("/WEB-INF/view/admin/board/boardUpdate.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect(req.getContextPath() + "/admin/boardDetail.do?boardNo=" + board.getBoardNo());
	}
}
